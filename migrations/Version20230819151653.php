 ...
 */
final class Version20230819151653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE authors (id INT NOT NULL, name VARCHAR(128) NOT NULL, number_books INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE books (id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(1024) DEFAULT NULL, publication_date DATE DEFAULT NULL, PRIMARY KEY(id))');
